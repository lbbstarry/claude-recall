...
def search(
    ...
    *,
    ...
    bm = bm25.search(conn, query, limit=candidates, filters=filters, project=project)
    vc = vector.search(conn, embedder, query, limit=candidates, filters=filters, project=project)
